...
namespace API.Data
{
    public static class DbInitializer
    {
        public static async Task Initialize(StoreContext context, UserManager<User> userManager)
        {
            ...
            {
                var user = new User { UserName = "John", Email = "John@mail.com" };
                await userManager.CreateAsync(user, "!@#$09456Kharlcess06");
                await userManager.AddToRoleAsync(user, "Member");

                var admin = new User { UserName = "Doe", Email = "Doe@mail.com" };
                await userManager.CreateAsync(admin, "!@#$09456Kharlcess06");
